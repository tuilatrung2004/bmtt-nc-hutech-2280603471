...
context.load_cert_chain(certfile= r"M:\bmtt-nc-hutech-2280603471\LAB_05\ssl\certificates\server-cert.crt",
                        keyfile= r"M:\bmtt-nc-hutech-2280603471\LAB_05\ssl\certificates\server-key.key")
